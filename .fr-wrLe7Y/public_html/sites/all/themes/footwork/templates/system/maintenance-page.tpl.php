  ...
  <body class="<?php print $classes; ?>" <?php print $body_attributes;?>>
    ...
    <div id="page" role="document">
      ...
      <div id="main" role="main" class="clearfix">
        <div class="fb-like-box" data-href="http://www.facebook.com/footworkMK" data-width="230" data-colorscheme="dark" data-show-faces="true" data-header="true" data-stream="true" data-show-border="false"></div>
